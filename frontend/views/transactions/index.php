                ...
                [
                    ...
                    'value' => function($model, $key, $index, $column) {
                        if ($model->status == "1") {
                            ...
                            return Html::tag('span', 'Complete', ['class' => 'badge bg-success', 'style' => ['font-size' => '15px']]);
                        } else if ($model->status == "0") {
                            return Html::tag('span', 'Pending', ['class' => 'badge bg-warning', 'style' => ['font-size' => '15px']]);
                        } else {
                            return Html::tag('span', 'Failed', ['class' => 'badge bg-danger', 'style' => ['font-size' => '15px']]);
                        }
                    },
                ],
                #'desc:ntext',

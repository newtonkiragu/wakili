                        ...
                        [
                            ...
                            'value' => function($model, $key, $index, $column) {
                                if ($model->type == 1) {
                                    ...
                                    return Html::tag('span', '  General', ['class' => 'badge bg-success', 'style' => ['font-size' => '15px']]);
                                } elseif ($model->type == 2) {
                                    return Html::tag('span', ' Advocate ', ['class' => 'badge bg-warning', 'style' => ['font-size' => '15px']]);
                                    // return Html::tag('span', '  Advocate ', ['class' => 'label label-danger fa fa-close', 'style' => ['font-size' => '15px']]);
                                } else {
                                    return Html::tag('span', 'Law firm ', ['class' => 'badge bg-danger', 'style' => ['font-size' => '15px']]);
                                }
                            },
                                ],
                                [

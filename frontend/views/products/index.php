               ...
               [
                ...
                [
                            ...
                            'value' => function($model, $key, $index, $column) {
                                if ($model->level_one == '1') {

                                    return Html::tag('span', '  Standard', ['class' => 'badge bg-success', 'style' => ['font-size' => '15px']]);
                                } elseif ($model->level_one == '2') {
                                    return Html::tag('span', ' Precedents ', ['class' => 'badge bg-warning', 'style' => ['font-size' => '15px']]);
                                    // return Html::tag('span', '  Advocate ', ['class' => 'label label-danger fa fa-close', 'style' => ['font-size' => '15px']]);
                                } else {
                                    return Html::tag('span', '', ['class' => 'badge bg-danger', 'style' => ['font-size' => '15px']]);
                                }
                            },
                                ],
                'level_two',
